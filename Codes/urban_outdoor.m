% 'urban_outdoor_trajectory' MATLAB file plots the trajectory of RTK-GPS and  VINS in Google Map for visualization purposes.
% 
...
% 'urban_outdoor_vins'  bag contains data for VINS trajectory and
% 'urban_outdoor'  bag contains data for RTK GPS trajectory

bag1 = rosbag ('C:\Users\aruns\OneDrive\Desktop\RSN\final_project\urban_outdoor_vins.bag');
bag2 = rosbag ('C:\Users\aruns\OneDrive\Desktop\RSN\final_project\urban_outdoor.bag');
...
lat = lat_a(500:length(lat_a));
lon = lon_a(500:length(lon_a));
...
gps_timePoints = gps_timePoints_a(500:length(gps_timePoints_a));
